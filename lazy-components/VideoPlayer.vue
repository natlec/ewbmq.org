...
.plyr {
  ...
  --plyr-tooltip-color: var(--color-light-gray);
  --plyr-tooltip-background: var(--color-black);
  --plyr-tooltip-radius: 8px;
  --plyr-menu-color: var(--color-light-gray);
  --plyr-menu-background: var(--color-black);
  --plyr-menu-back-border-color: rgba(0, 0, 0, .25);
  --plyr-menu-back-border-shadow-color: transparent;
  --plyr-menu-arrow-color: var(--color-light-gray);
  --plyr-menu-radius: 8px;
  --plyr-badge-background: var(--color-green);
  ...
  --plyr-font-size-base: .889em;
  --plyr-font-size-small: .889em;
...
@media (min-width: 480px) {
  .plyr--video .plyr__controls {
    padding: calc(var(--plyr-control-spacing, 10px) * 3.5)
      var(--plyr-control-spacing, 10px) var(--plyr-control-spacing, 10px);
  }
}
