<template>
  <main>
    ...
    <div id="content" class="content">
      ...
      <section id="members" class="c-section">
        <div class="c-section-double">
          <div class="c-section-double-left">
            <h2>
              Membership
...
.c-bubbles-item-image {
  width: 196px;
  z-index: 1;
}
.c-bubbles-item-byline {
  margin: 24px 0 0;
}
...
.c-bubbles-item-image-container {
  display: block;
  position: relative;
  border-radius: 100%;
  width: 196px;
